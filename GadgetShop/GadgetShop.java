...
public class GadgetShop extends Application
{
    ...
    private final TextField intitialCreditField = new TextField();
    ...
    public void start(Stage stage)
    {
        ...
        /* Intital Credit */
        Label intitialCredit = new Label("Initial Credit:");
        ...
        /* Initial Credit */
        intitialCreditField.setLayoutX(140);
        intitialCreditField.setLayoutY(140);
        ...
        try 
        {
            Mobile newMobile = new Mobile(modelField.getText(),
                ...
                Integer.parseInt(weightField.getText().trim()), Integer.parseInt(intitialCreditField.getText().trim()));
             
            gadgets.add(newMobile);
            
            logArea.appendText(System.lineSeparator() + "Added: " + newMobile + System.lineSeparator());
        ...
        catch (NumberFormatException ex)
        {
            ...
            "Size: String, " + System.lineSeparator() + "Price: Number, " + System.lineSeparator() + 
            "Weight: Number, " + System.lineSeparator() + "Initial Credit: Number ");
            displayNumberField.setText("-1");
        }
        });
        ...
        try 
        {
            ...
            logArea.appendText(System.lineSeparator() + "Added: " + newMP3 + System.lineSeparator());
        ...
        {
            showError("Input Error", "Check if the values are correct. " + System.lineSeparator() + "Model: String, " + 
            System.lineSeparator() + "Size: String, " + System.lineSeparator() + "Price: Number, " + System.lineSeparator() + 
        ...
        logArea.appendText(System.lineSeparator() + "----- Display All Gadgets -----" + System.lineSeparator());
        ...
        try
        {
            ...
            for (Gadget g : gadgets) {
                if (show instanceof Mobile) {
                    ...
                    intitialCreditField.setText(String.valueOf(m.getCallingCredit()));
                    availableMemoryField.setText("");
                }
        ...
        {   
            ...
            if (show instanceof Mobile) {
                ...
                alert.showAndWait();
                /*intitialCreditField.setText(); se quisers arrjr fomra de tualizar*/
            } 
            else
            {
        ...
        catch (NumberFormatException ex)
        {
            ...
            "Model: String, " + System.lineSeparator() + "Size: String, " + System.lineSeparator() 
            + "Price: Number, " + System.lineSeparator() + "Weight: Number, " + System.lineSeparator() 
            + "Initial Credit: Number ");
        }
        catch (Exception ex) 
        {
        ...
        root.getChildren().addAll(logArea, modelLabel, musicDownload, makeCall, addMP3, clear, displayAll, 
        addMobile, priceLabel, weightLabel, sizeLabel, intitialCredit, availableMemory, phoneNumberField, 
        phoneNumber, duration, downloadSize, modelField, priceField, sizeField, weightField, 
        intitialCreditField, availableMemoryField, durationField, downloadSizeField, displayNumberField, 
